...
export function InviteGuestsModal({
    addNewEmailToInvite, closeGuestsModal, emailsToInvite, removeEmailFromInvites
...
//propriedades: permitem que haja envio de variaveis um componente pai para um filho